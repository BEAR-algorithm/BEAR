    ...
    with open(filepath) as fp:
        while line and cnt< 20242: ##20242
            ...
            for feature_index, feature_value in enumerate(line_splited[1:]):
                ...
                feature = mmh3.hash(str(feature),0) % embedding_dim
                value = float(value)
...
filehandler = open("results/FH-SGD-b5-step01-e25000-loss.p", 'wb')
pickle.dump(training_loss_store, filehandler)
filehandler.close()
filehandler = open("results/FH-SGD-b5-step01-e25000-cnt.p", 'wb')
pickle.dump(cnt_store, filehandler)
filehandler.close()
filehandler = open("results/FH-SGD-b5-step01-e25000-time.p", 'wb')
...
with open(filepath) as fp:
    while line and cnt < 677399 : ##677399
        if cnt % 10000 == 0:
            print(cnt)
...
## store
file = open("results/FH-SGD-b5-step01-e25000-log.txt","w")
file.write("Average test loss %f \n" %np.mean(np.asarray(total_test_loss)) )
file.write("Average test accuracy %f \n" % acc_val )
file.close()

filehandler = open("results/FH-SGD-b5-step01-e25000-test-ground-truth.p", 'wb')
pickle.dump(ground_truth_TEST, filehandler)
filehandler.close()

filehandler = open("results/FH-SGD-b5-step01-e25000-test-prediction.p", 'wb')
